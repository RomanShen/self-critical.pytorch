...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='../data/dataset_rsicd.json',
                        help='input json file to process into hdf5')
    parser.add_argument('--output_h5', default='../data/processed_image.h5',
                        help='output h5 file')

    # options
    parser.add_argument('--max_length', default=30, type=int,
                        help='max length of a caption, in number of words. captions longer than this get clipped.')
    parser.add_argument('--images_root', default='data/RSICD_images',
